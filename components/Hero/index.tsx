          ...
          <div className="flex flex-wrap items-center justify-center">
            <div className="flex w-full justify-center px-4 md:w-1/3">
              ...
              <div className="text-center">
                ...
                <Image
                  src="/images/p.jpg.jfif"
                  className="border-blue-500 h-40 w-40 rounded-full border bg-yellow md:h-72 md:w-72"
                  alt="Your Image"
                  width={400}
                  height={400}
                />
            ...
            <div className="w-full px-4 md:w-2/3">
              {" "}
              {/* Adjust the width for the text */}
              <div className="wow fadeInUp mx-auto max-w-[800px] text-center">
                <p className="mb-8 mt-4 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  Hey, Myself
                </p>
